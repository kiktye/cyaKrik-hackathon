<x-layout>
    <div class="container mx-auto p-8">
        <!-- Title -->
        <h1 class="text-3xl font-bold mb-8 text-center">Проекти (Projects)</h1>

        <!-- Current Projects (Тековни) -->
        <h2 class="text-2xl font-bold mb-4">Тековни (Current)</h2>
        <div id="current-projects-section">
            @include('project.partials.current_projects')
        </div>

        <!-- Completed Projects (Завршени) -->
        <h2 class="text-2xl font-bold mt-12 mb-4">Завршени (Completed)</h2>
